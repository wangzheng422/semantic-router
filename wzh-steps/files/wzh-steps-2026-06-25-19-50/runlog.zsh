...

{
  ...
  print -r -- "| stdout | [${safe_label}.stdout.txt](files/wzh-steps-2026-06-25-19-50/${safe_label}.stdout.txt) (${stdout_lines} lines, ${stdout_bytes} bytes) |"
  print -r -- "| stderr | [${safe_label}.stderr.txt](files/wzh-steps-2026-06-25-19-50/${safe_label}.stderr.txt) (${stderr_lines} lines, ${stderr_bytes} bytes) |"
  print -r -- "| meta | [${safe_label}.meta.txt](files/wzh-steps-2026-06-25-19-50/${safe_label}.meta.txt) |"
} >> "$WZH_STEPS_MD"
